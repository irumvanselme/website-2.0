...
export default function Header() {
    ...
    return (
        <div
            className={
                'h-10 lg:h-16 bg-white dark:bg-black sticky top-0 text-[#060F33] xxs:px-2 xs:px-4 sm:px-6 lg:px-32 xl:px-36 2xl:px-56 3xl:px-[272px] 4xl:px-[464px] 5xl:px-[784px] 6xl:px-[1224px] z-20'
            }
        >
